...
- **Deployment method**: how have you deployed this application? If possible, could you paste your configuration? (don't forget to strip passwords or other sensitive data!)
- Commit SHA.
